    ...
    <View style={{ flex: 1, width: '100%'}}>
      <FlatList
        ...
        renderItem={({ item }: { item: Gift }) => (
          <View
            style={{ borderRadius:12, backgroundColor: 'white', margin: 10, justifyContent: 'center', alignItems: 'center', width: windowWidth * 0.4 }}
          >
            <View
            style={{
              position: 'absolute',
          ...
          >
            ...
            <View style={{ alignItems: 'center', backgroundColor: '#FFD76C', width: windowWidth * 0.4, borderBottomLeftRadius: 12, borderBottomRightRadius: 12}}>
              ...
              <View style={{ flexDirection: 'row'}}>
                ...
                <Text style={[{ color: item.status ? '#00A61B' : '#D02027',fontSize: 16, fontFamily: 'SwissBold'  }]}>
